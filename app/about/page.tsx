      ...
      <AboutContainer>
        <AboutContent>
          ...
          <Description className="md:max-w-3xl">
            ...
            (SSE,MicroSoft). Where I have learnt full stack web development with
            MERN and within six months I was able to complete five full-stack
            projects from scratch. I have also written some blogs during that
            time which have been read more than 2500 times already.
            <br />
            <br />
            ...
            The Month for the month of JUNE,2022 due to my tech and non-tech
            contribution for the company.
            <br />
            <br />
            After a eventful year at Bangalore and INVACT, currently I am taking
            a break and back to home, spending some time with family.
            <br />
            <br />
          </Description>
        </AboutContent>
